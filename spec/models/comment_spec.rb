...
RSpec.describe Comment, type: :model do
  ...
  this_post = Post.new(author: this_user, title: 'new post', text: 'Lorem Ipsum etc.', comments_counter: 0, likes_counter: 0)
  comment = Comment.new(author: this_user, post: this_post, text: 'New Comment Who Dis')

  before {this_user.save
    this_post.save
    comment.save
  }
  ...
  context 'Update comment counter' do
    before {Comment.new(author: this_user, post: this_post, text: 'Another Comment')
    p this_post.comments}
