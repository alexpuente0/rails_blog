...
RSpec.describe Post, type: :model do
  ...
  this_post = Post.new(author: this_user, title: 'Appropiate Title', text: 'Lorem Ipsum etc', comments_counter: 1, likes_counter: 1)
  this_post.save
...
describe 'Post Validation Fails for Comment Counter' do
  context 'Fails' do
    before {this_post.title = 'Appropiate Title'
...
describe 'Post Validation Fails for Likes Counter' do
  context 'Fails' do
      before {this_post.comments_counter = 1
...
describe 'Method Functionality' do
  ...
  context 'Update posts counter' do
    before {Post.new(author: this_user, title: 'new post', text: 'Lorem Ipsum etc', comments_counter: 0, likes_counter: 0)}
